...
/**
 * Test de l'authentification hybride recommandée
 * Bearer Token pour recherches + OAuth 1.0a pour actions utilisateur
 */

async function testHybridAuth() {
    console.log('🔧 Test de l'authentification hybride (SOLUTION RECOMMANDÉE)\n');
    
    // Configuration comme dans votre app
    ...
    // Test 1: Recherche avec Bearer Token (recommandé)
    ...
    // Test 2: Informations utilisateur avec OAuth 1.0a (recommandé)
    ...
    try {
        // Test de capacité (sans effectuer l'action)
